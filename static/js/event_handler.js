document.addEventListener('DOMContentLoaded', domReady);
        ...
        function dl3dvSceneEvent(idx) {
            ...
            for (let i = 0; i < imagesLength; i++) {
                ...
                switch (idx) {
                    case 0:
                        image.src = 'resources/wcg_ablation/merge_scene0036_1';
                        break;
                    case 1:
                        image.src = 'resources/wcg_ablation/merge_scene0972_11';
                        break;
                    case 2:
                        image.src = 'resources/wcg_ablation/2b65ba886e';
                        break;
                }
                switch (i) {
                    case 0:
                        image.src = image.src + '/no_warp_guide_rgb.png';
                        break;
                    case 1:
                        image.src = image.src + '/rgb_full.png';
                        break;
                    case 2:
                        image.src = image.src + '/ground_truth.png';
                        break;
                }
            }
